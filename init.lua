...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').add {
        ...
        { '<leader>w', ':update<CR>', desc = '[W]rite file' },
      }
    end,
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sF', builtin.git_files, { desc = '[S]earch [F]iles (Git Repo)' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- WARN: neither of the next two actually work
          -- TODO: fix
  ...
  { -- You can easily change to a different colorscheme.
    ...
    -- maybe try https://github.com/ellisonleao/gruvbox.nvim
